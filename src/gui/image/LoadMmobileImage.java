...
public class LoadMmobileImage {
	/*
	 * SK 로고
	 */
	public Image getMmobileLogoImg() {
		File imageFile = new File(".//image//lowprice//mmobile_logo.png");
	...
	public Image getPriceTableImg() {
		File imageFile = new File(".//image//lowprice//mmobile_table.png");
		Image PictureImg = null;
		Image setSizeImg = null;
		try {
			PictureImg = ImageIO.read(new File(imageFile.getAbsolutePath()));
