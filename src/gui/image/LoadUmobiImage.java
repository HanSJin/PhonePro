...
public class LoadUmobiImage {
	/*
	 * SK 로고
	 */
	public Image getUmobiLogoImg() {
		File imageFile = new File(".//image//lowprice//umobi_logo.png");
	...
	public Image getPriceTableImg() {
		File imageFile = new File(".//image//lowprice//umobi_table.png");
		Image PictureImg = null;
		Image setSizeImg = null;
		try {
			PictureImg = ImageIO.read(new File(imageFile.getAbsolutePath()));
